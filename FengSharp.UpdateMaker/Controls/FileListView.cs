...
namespace FengSharp.UpdateMaker.Controls
{
    public class FileListView : System.Windows.Forms.ListView
    {
        ...
        public Version GetVersion(string pathkey, string fullPath)
        {
            ...
            var ver = ExtensionMethod.ConvertVersionInfo(System.Diagnostics.FileVersionInfo.GetVersionInfo(fullPath));
        ...
        void LoadFilesIntoList()
        {
            ...
            foreach (var item in Files)
            {
                ...
                lv.SubItems.Add(ExtensionMethod.ToSizeDescription(item.Value.Length));
        ...
        public UpdateInfo CurrentUpdateInfo
        {
            ...
            set
            {
                ...
                if (value.UpdateFiles != null)
                {
                    value.UpdateFiles.Where(s => s.UpdateMethod != UpdateMethod.Always)
                        .ForEach(s =>
                        {
                            _updateMethods.Add(s.FilePath, s.UpdateMethod);

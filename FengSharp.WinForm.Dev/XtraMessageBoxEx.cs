...
#pragma warning disable 0618
    public class XtraMessageBoxEx
    {
        ...
        {
            Initialize();
            return XtraMessageBox.Show(lookAndFeel, text, caption);
        }
        ...
        {
            Initialize();
            return XtraMessageBox.Show(text, caption, buttons, icon, defButton);
        }
        ...
        public static DialogResult Show(IWin32Window owner, string text)
        {
            _owner = owner;
            Initialize();
            return XtraMessageBox.Show(owner, text);
        }
        ...
        public static DialogResult Show(IWin32Window owner, string text, string caption)
        {
            _owner = owner;
            Initialize();
            return XtraMessageBox.Show(owner, text, caption);
        }
        ...
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons)
        {
            _owner = owner;
            Initialize();
            return XtraMessageBox.Show(owner, text, caption, buttons);
        }
        ...
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defButton)
        {
            _owner = owner;
            Initialize();
            return XtraMessageBox.Show(owner, text, caption, buttons, icon, defButton);
        }
        ...
        public static DialogResult Show(UserLookAndFeel lookAndFeel, IWin32Window owner, string text)
        {
            _owner = owner;
            Initialize();
            return XtraMessageBox.Show(lookAndFeel, owner, text);
        }
        ...
        public static DialogResult Show(UserLookAndFeel lookAndFeel, IWin32Window owner, string text, string caption, MessageBoxButtons buttons)
        {
            _owner = owner;
            Initialize();
            return XtraMessageBox.Show(lookAndFeel, owner, text, caption, buttons);
        }
        ...
        {
            Initialize();
            return XtraMessageBox.Show(lookAndFeel, text, caption, buttons, icon);
        }
        ...
        {
            Initialize();
            return XtraMessageBox.Show(lookAndFeel, text, caption, buttons, icon, defaultButton);
        }
        public static DialogResult Show(IWin32Window owner, string text, string caption, DialogResult[] buttons, Icon icon, int defaultButton, MessageBoxIcon messageBeepSound)
        {
            _owner = owner;
            Initialize();
            return XtraMessageBox.Show(owner, text, caption, buttons, icon, defaultButton, messageBeepSound);
        }
